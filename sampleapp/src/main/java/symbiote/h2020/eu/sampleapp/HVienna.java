...
public class HVienna extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(HVienna.this, MainActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hvienna);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(HVienna.this);
        ...
        for(int counter = 0;counter<arrayList12.size();counter++){
            ...
            System.out.println(totalpm25);

        }

        System.out.println("finalpm25");


        String json13 = sharedPrefs.getString("array_vienna_pm10", "");
        ...
        for(int counter = 0;counter<arrayList13.size();counter++){
            ...
            System.out.println(totalpm10);

        }

        System.out.println("finalpm10");



        String json14 = sharedPrefs.getString("array_vienna_nitrogen", "");
...
//Y-axis
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HVienna.this, Historical.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HVienna.this, Hzagreb.class));
            }
        });
