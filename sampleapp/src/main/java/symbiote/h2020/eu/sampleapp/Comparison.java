...
public class Comparison extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Comparison.this, Charts.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float value1 = pm25Limassol.get(0);
        float value2 = pm25Vienna.get(0);
        float value3 = pm25Zagreb.get(0);
...
//Y-axis
        ...
        two.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Comparison.this, PM10.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Comparison.this, NO2.class));
            }
        });
