...
public class NO2 extends AppCompatActivity {
    ...
    ArrayList<Float> nitrogenVienna = new ArrayList<Float>();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(NO2.this, Charts.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(NO2.this, Comparison.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NO2.this, PM10.class));
            }
        });

        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(NO2.this);
        ...
        String json12 = sharedPrefs.getString("array_vienna_nitrogen", "");
        ...
        System.out.println("Length is: "+nitrogenVienna.size());


        String json13 = sharedPrefs.getString("array_zagreb_nitrogen", "");
        ...
        System.out.println("Length is: "+nitrogenZagreb.size());
        ...
        float value1 = nitrogenLimassol.get(0);
        float value2 = nitrogenVienna.get(0);
        float value3 = nitrogenZagreb.get(0);
