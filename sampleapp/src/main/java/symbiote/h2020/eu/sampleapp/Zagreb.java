...
public class Zagreb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(Zagreb.this);
        ...
        float var3 = nitrogenZagreb.get(0);
        if(var3<=100){
        ...
        float var5 = sulphurZagreb.get(0);
        if(var5<=150){
